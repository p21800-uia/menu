...
public class MenuNuevoContacto extends APantalla {
    ...
    public MenuNuevoContacto(String menú_principal, String s, String[] opciones, String s1, String s2) {
